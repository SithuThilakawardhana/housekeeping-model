...
<head>
    ...
    <title>Update Fresh Linen Item</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container mt-5">
        <h2>Update Fresh Linen Item</h2>

        <form action="${pageContext.request.contextPath}/UpdateFreshLinenItemServlet" method="post" class="needs-validation" novalidate>
