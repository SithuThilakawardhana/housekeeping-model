...
<head>
    ...
    <title>Update Toiletries Item</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container mt-5">
        <h2>Update Toiletries Item</h2>

        <form action="${pageContext.request.contextPath}/UpdateToiletriesItemServlet" method="post" class="needs-validation" novalidate>
            <!-- Hidden input to pass the item's id -->
